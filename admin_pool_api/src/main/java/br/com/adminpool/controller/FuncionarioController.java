...
public class FuncionarioController {
 ...
 @GetMapping public List<Funcionario> listar(){return funcionarios.findAll();}
 @PostMapping public ResponseEntity<Funcionario> criar(@RequestBody NovoFuncionarioRequest r){
